...
<div class="row">
  ...
  <div class="collapse" id="collapse-excel">
    <div class="well">
      <form action="{{route('ambilExcelResep', 'xlsx')}}" method="post" id="frm-excel" target="_blank">
      {{csrf_field()}}
  ...
  <div class="collapse" id="collapse-pdf">
    <div class="well">
      <form action="{{route('ambilPDFResep')}}" method="post" id="frm-pdf">
      {{csrf_field()}}
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          <div class="form-group">
          <label>Pilih Bulan ?</label>
        ...
        <table id="datatable" class="table table-striped">
          ...
          @foreach($resep as $data)
            <tr>
              ...
              <td>
                <a href="{{ route('ambilPrintDetailResep', $data['pasien']['id']) }}" target="_blank" class="btn btn-info btn-flat"><i class="fa fa-print"></i></a>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#datatable').on('click', '.btn-detail', function(event) {
        ...
        $.get("{{route('ambilIsiResep')}}", {pasien_id:pasien_id}, function(data) {
