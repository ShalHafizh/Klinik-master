    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                ...
                <img src="{{ URL::to('images/', Auth::guard('loket')->user()->getPhoto()) }}" alt="" class="img-circle profile_img">
                @else
                <img src="{{URL::to('images/user-admin.jpg')}}" alt="" class="img-circle profile_img">
                Resepsionist
                @endif
              ...
              <div class="profile_info">
                ...
                @elseif(Auth::guard('loket')->check())
                {{ Auth::guard('loket')->user()->username }}
                @endif
                </h2>
              </div>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="{{ route('adminResepsionist') }}"><i class="fa fa-clipboard"></i> Resepsionist</a></li>
                <li><a href="{{ route('adminDokter') }}"><i class="fa fa-user-md"></i> Dokter</a></li>
                <li><a href="{{ route('adminLoket') }}"><i class="fa fa-fa fa-clipboard"></i> Loket</a></li>
                <li><a href="{{ route('getPoli') }}"><i class="fa fa-fa fa-heartbeat"></i> Poli</a></li>
                </li>
                @elseif(Auth::guard('resepsionist')->check())
                <li><a href="{{ route('resepsionist.index') }}"><i class="fa fa-clipboard"></i> Scan Data Pasien</a>
              </li>
          ...
          <li><a href="{{ route('getPembayaran') }}"><i class="fa fa-file-text"></i> Data Pemeriksaan </a>
  ...
  <ul class="nav navbar-nav navbar-right">
    <li class="">
      <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
        ...
        @elseif(Auth::guard('loket')->check())
        <img src="{{ URL::to('images/', Auth::guard('loket')->user()->getPhoto()) }}" alt="">
        {{ Auth::guard('loket')->user()->username }}
        @else
        <img src="{{URL::to('images/user-admin.jpg')}}" alt="">
        Resepsionist
