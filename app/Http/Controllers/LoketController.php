...
class LoketController extends Controller
{
    ...
    public function getRekamMedisPasien($pasien_id, $nama, $tgl_lahir) {
        ...
        // dd($id);
        return view('loket.pasien-rekam-medis', ['pasien' => $pasien, 'rekamMedis' => $rekamMedis, 'obat' => $obat, 'id' => $id, 'nama' => $nama, 'tgl_lahir' => $tgl_lahir, 'umur' => $umur]);
    }
    ...
    public function getRekamMedis() {
    	...
    	return view('loket.rekam-medis', ['rekamMedis' => $rekamMedis, 'HariIni' => $HariIni]);
    }
    ...
    public function exportPDFRekamMedis(Request $request) {
        ...
        return view('loket.pdf', ['bulan' => $bulan, 'tahun' => $tahun, 'rekamMedis' => $rekamMedis]);
    }
    ...
    public function getPembayaran() {
    	...
    	return view('loket.pembayaran', ['pembayaran' => $pembayaran, 'hariIni' => $hariIni, 'dokter' => $dokter]);
    }
